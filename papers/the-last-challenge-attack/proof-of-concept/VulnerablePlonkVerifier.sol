...
contract VulnerablePlonkVerifier {

  bytes4 internal constant ERR_S = 0xf7b44074; // Custom error to be able to extract values easily from the assembly code.
  ...
  function Verify(bytes calldata proof, uint256[] calldata public_inputs) public view returns (bool success) {
    assembly {
      ...
      function batch_verify_multi_points(aproof) {
        ...
        // mstore(0x00, ERR_S) // Uncomment to get u
        // mstore(0x04, random)
        // mstore(0x24, 0x00)
        // mstore(0x44, 0x00)
        // revert(0x00, 0x64)
        ...
        // mstore(0x00, ERR_S) // Uncomment to get C = F - E (x and y)
        // mstore(0x04, mload(folded_digests)) 
        // mstore(0x24, mload(add(folded_digests, 0x20))) 
        // mstore(0x44, 0x00) 
        // revert(0x00, 0x64)  
        ...
        // mstore(0x00, ERR_S) // Uncomment to get w and z
        // mstore(0x04, vk_omega) 
        // mstore(0x24, mload(add(state, state_zeta))) 
        // mstore(0x44, 0x00) 
        // revert(0x00, 0x64)  
      ...
      function verify_quotient_poly_eval_at_zeta(aproof) {
        ...
        // mstore(0x00, ERR_S) // Uncomment to get computed quotient and state_zeta_power_n_minus_one
        // mstore(0x04, mload(computed_quotient)) 
        // mstore(0x24, mload(add(state, state_zeta_power_n_minus_one))) 
        // mstore(0x44, 0x00) 
        // revert(0x00, 0x64)  
